    ...
    <PortalLayout>
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-gradient-to-r from-neuro-primary to-neuro-secondary rounded-lg p-8 text-white">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-lg text-neuro-light/90 mt-2">
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a href="/docs/admin/admin-node-design.md" className="flex items-center gap-3 p-4 border rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <a href="/docs/admin/admin-node-genesis.md" className="flex items-center gap-3 p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <ExternalLink className="w-5 h-5 text-blue-500" />
              <div>
            ...
            <a href="/docs/admin-node-production-setup.md" className="flex items-center gap-3 p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <ExternalLink className="w-5 h-5 text-blue-500" />
              <div>
            ...
            <a href="/docs/CONTRIBUTOR-GUIDE.md#admin-node-awareness" className="flex items-center gap-3 p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <ExternalLink className="w-5 h-5 text-blue-500" />
              <div>
        ...
        <div className="text-center py-8 border-t">
          ...
          <p className="text-lg font-semibold text-neuro-primary">
