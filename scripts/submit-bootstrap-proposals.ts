...
async function submitBootstrapProposals() {
  ...
  const roadmapTemplatePath = path.join(__dirname, '..', '..', 'neuroswarm', 'docs', 'proposals', 'roadmap-priorities-template.md');
  const workingGroupTemplatePath = path.join(__dirname, '..', '..', 'neuroswarm', 'docs', 'proposals', 'working-group-formation-template.md');
